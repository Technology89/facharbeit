...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { Ausgeliegen: @machine.Ausgeliegen, Ausgeliehen_seit: @machine.Ausgeliehen_seit, Barcode: @machine.Barcode, Hersteller: @machine.Hersteller, Modell: @machine.Modell }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { Ausgeliegen: @machine.Ausgeliegen, Ausgeliehen_seit: @machine.Ausgeliehen_seit, Barcode: @machine.Barcode, Hersteller: @machine.Hersteller, Modell: @machine.Modell }
    assert_redirected_to machine_path(assigns(:machine))
  end
